app.controller('MusicCtrl', function ($scope, $http, $stateParams, $location, $ionicLoading, $sce, Loader) {
    ...
    $scope.addPlayList = function (album_id) {
        method = "Playlist.Add";
        params = '{"playlistid":0,"item":{"albumid":' + album_id + '}}';
    ...
    $scope.playSong = function (album_id) {
    ...
    $scope.playerOpen = function(){
        ...
        param_url = '/jsonrpc?request={"jsonrpc":"2.0","method":"' + method + '", "params":' + params + ',"id":4}';
        complete_url = window.base_url + param_url;
