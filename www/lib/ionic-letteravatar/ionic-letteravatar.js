...
(function () {
	...
	nla.constant('defaultSettings', {
		alphabetcolors : ["#F44336", "#E91E63", "#9C27B0", "#673AB7", "#3F51B5", "#2196F3","#009688","#0091EA","#004D40","#43A047","#1B5E20","#827717","#33691E", "#E65100", "#FF5722", "#795548", "#607D8B"],
		textColor : '#ffffff',
				...
				return {
					...
					link : function (scope, element, attrs) {
						...
						if (c.charCodeAt(0) < 65) {
							...
							color = defaultSettings.alphabetcolors[Math.floor(Math.random() * defaultSettings.alphabetcolors.length)];
						}
